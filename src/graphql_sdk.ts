...
export type ListTemplatesMinimalQuery = {
	__typename?: 'Query';
	templates: Array<{ __typename?: 'Template'; id: string; name: string; orgId: string; updatedAt: string }>;
};
...
export type UpdateTemplateBodyMutation = {
	__typename?: 'Mutation';
	updateTemplate?: { __typename?: 'Template'; body: string; id: string; updatedAt: string } | null;
};
...
export type UpdateTemplateNameMutation = {
	__typename?: 'Mutation';
	updateTemplate?: { __typename?: 'Template'; name: string; id: string; updatedAt: string } | null;
};
...
export type GetTemplateBodyQuery = {
	__typename?: 'Query';
	template?: { __typename?: 'Template'; body: string; updatedAt: string } | null;
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		listTemplatesMinimal(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<ListTemplatesMinimalQuery>(ListTemplatesMinimalDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'listTemplatesMinimal',
		...
		createTemplateMinimal(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<CreateTemplateMinimalMutation>(CreateTemplateMinimalDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'createTemplateMinimal',
		...
		updateTemplate(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UpdateTemplateMutation>(UpdateTemplateDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'updateTemplate',
		...
		UpdateTemplateBody(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UpdateTemplateBodyMutation>(UpdateTemplateBodyDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'UpdateTemplateBody',
		...
		UpdateTemplateName(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UpdateTemplateNameMutation>(UpdateTemplateNameDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'UpdateTemplateName',
		...
		getTemplateBody(
			variables: GetTemplateBodyQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
		): Promise<GetTemplateBodyQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetTemplateBodyQuery>(GetTemplateBodyDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getTemplateBody',
		...
		UserOrganization(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UserOrganizationQuery>(UserOrganizationDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'UserOrganization',
		...
		createOrgVariable(
			variables: CreateOrgVariableMutationVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
		): Promise<CreateOrgVariableMutation> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<CreateOrgVariableMutation>(CreateOrgVariableDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'createOrgVariable',
		...
		getOrgVariable(
			variables: GetOrgVariableQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
		): Promise<GetOrgVariableQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetOrgVariableQuery>(GetOrgVariableDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getOrgVariable',
